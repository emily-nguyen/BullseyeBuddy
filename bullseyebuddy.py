...
speech =  "Wuhf Bark. Item %s is located at aisle %s in block %s floor %s" % (a['general_description'], a['in_store_location'][0]['aisle'], a['in_store_location'][0]['block'], a['in_store_location'][0]['floor'])
